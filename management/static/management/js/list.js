const iconCopy = document.querySelectorAll(".card .card-content .icon");
iconCopy.forEach((icon) => {
  icon.addEventListener("click", function () {
    navigator.clipboard.writeText(this.dataset.content);
    this.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
